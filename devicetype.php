...
if(isset($_POST['dropdown'])) 
{
	...
	$result = mysqli_query($con,"SELECT * FROM register where dropdown='$dropdown' ORDER BY s_no ASC LIMIT $start_from, $limit");
	...
	<div class="container">
		<button onClick="javascript:history.go(-1)" style="float: left;"><i class="fa fa-arrow-left" style="font-size:36px;"></i></button><br><br>
            ...
            for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='devicetype.php?dropdown=".$dropdown."&page=".$i."'>".$i."</a></li>";	
              }
            echo $pagLink . "</ul>";  
            ?>
