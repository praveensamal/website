...
if(isset($_POST['model'])) 
{
	...
	$result = mysqli_query($con,"SELECT * FROM register where model='$model' ORDER BY s_no ASC LIMIT $start_from, $limit");
	...
	<div class="container">
		<button onClick="javascript:history.go(-1)" style="float: left;"><i class="fa fa-arrow-left" style="font-size:36px;"></i></button><br><br>
            ...
            for ($i=1; $i<=$total_pages; $i++) {
              $pagLink .= "<li class='page-item'><a class='page-link' href='model.php?model=".$model."&page=".$i."'>".$i."</a></li>";	
              }
            echo $pagLink . "</ul>";  
            ?>
